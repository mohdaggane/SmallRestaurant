...
<div class="min-h-screen login-page-bg py-8 sm:py-12 px-4 sm:px-6 flex flex-col justify-between font-sans antialiased">
    <div class="w-full max-w-md mx-auto my-auto">
        ...
        <div class="bg-white rounded-3xl p-7 sm:p-9 shadow-xl shadow-slate-200/80 border border-slate-100">
            ...
            <a href="<?= url('public/register.php') ?>"
               class="group flex items-center justify-between p-3.5 rounded-2xl bg-blue-50/60 hover:bg-blue-50 border border-blue-100 hover:border-blue-200 transition-all text-decoration-none">
                ...
                <div class="w-7 h-7 rounded-lg flex items-center justify-center text-blue-600 group-hover:translate-x-0.5 transition-transform">
